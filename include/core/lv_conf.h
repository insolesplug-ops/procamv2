/**
 * LVGL Configuration for CinePi Camera
 * Raspberry Pi 3A+ / Waveshare 4.3" DSI (480x800 Portrait)
 * LVGL 8.3.x
 */
...
extern uint32_t cinepi_lv_tick_get(void);
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (cinepi_lv_tick_get())
...
#define LV_FONT_MONTSERRAT_16  1   /* Used by SquareLine UI */
